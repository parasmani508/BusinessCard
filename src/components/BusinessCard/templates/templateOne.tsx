...
>
  ...
  <div className="flex flex-col space-y-3 flex-1 mr-4">
    ...
    <div className="flex items-start">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-4 w-4 text-red-600 mr-2 flex-shrink-0 mt-1" fill="none" stroke="currentColor">
        <path
          strokeLinecap="round"
      ...
      <p className="text-sm text-gray-800 break-words">{data.phone}</p>
    </div>
  ...
  <div className="w-16 h-16 rounded-full bg-rgb(169,11,12) flex items-center justify-center shadow-lg border-2 border-white flex-shrink-0">
