  ...
  <div className="text-gray-700">
    <div className="flex items-center mb-2">
      <div className="w-5 h-5 flex-shrink-0 mr-2">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-full h-full text-[#00C28B]" fill="none" stroke="currentColor">
          <path
            strokeLinecap="round"
    ...
    <div className="flex items-center">
      ...
      <p className="text-sm text-[#00C28B]">{data.address}</p>
    </div>
  </div>
</div>
