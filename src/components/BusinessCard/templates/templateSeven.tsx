...
export const templateSeven: React.FC<TemplateProps> = ({ data }) => (
    <div
    ...
    >
        ...
        {data.name}
            ...
            {/* </div> */}
            <h2 className="text-xl font-bold text-[#ffffff]">{data.name}</h2>
        </div>
        ...
        <div className="space-y-3 mb-10">
            ...
            <div className="flex items-center space-x-3">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5 text-[#7e7c78]" fill="currentColor">
            ...
            <div className="flex items-start space-x-3">
                <svg
                    ...
                    viewBox="0 0 24 24"
                    className="h-5 w-5 shrink-0 text-[#7e7c78]"
                    fill="currentColor"
                >
                    <path d="M12 2a7 7 0 00-7 7c0 5.25 7 12 7 12s7-6.75 7-12a7 7 0 00-7-7zm0 9a2 2 0 112-2 2 2 0 01-2 2z" />
                </svg>
                <p className="text-sm text-gray-200 break-words">{data.address}</p>
            </div>
